    ...
    <div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginTop: '30px' }}>
        <div style={{ marginRight: '20px' }}>
          ...
          <select style={{width:'100%'}} className="select-field" name="company" value={selectedCompany} onChange={handleCompanyChange}>
            <option value="all" disabled>--Select Company--</option>
        ...
        <div style={{ marginTop: '20px' }}>
          <label className="label" htmlFor="topic">
            ...
            <select style={{width:'100%'}} className="select-field" name="topic" value={selectedTopic} onChange={handleTopicChange}>
              <option value="all" disabled>--Select Topic--</option>
              {topicList.map(topic => (
