    ...
    <div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginTop: '30px' }}>
        <div style={{ marginRight: '20px' }}>
          ...
          <select style={{width:'100%'}} className="select-field" name="company" value={companyName} onChange={handleCompanyNameChange}>
            <option value="all" disabled>all company</option>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <select className="select-field" name="programmingLanguage" value={programmingLanguage} onChange={handleProgrammingLanguageChange}>
            <option value="all" disabled>all programming</option>
